package com.bawei.dome_rcycleviewstyle;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initData() {
        /**这里的图片就上网百度了8张。本人比较懒就用本地图片代替。
         当然你要有现成的接口也可以网络加载解析。*/
        int[] intimage = {R.drawable.s, R.drawable.s, R.drawable.s, R.drawable.s,
                R.drawable.s, R.drawable.s, R.drawable.s, R.drawable.s};
        for (int i = 0; i < 8; i++) {
